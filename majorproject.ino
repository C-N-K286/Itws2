...
int P1paddlePos;
int P2paddlePos;                      // Position of the player's paddle (14 possible positions)
int ballPos[2];                       // X, Y coordinates of the bal
int P1points;                         // Keeps track of how many balls have passed the players boundary (game is to 3)
int P2points;
...
float speedIncreasePercent = 15;      // Speed increase percentage when the player successfully bounces the ball off their paddle
...
void Send()
{
      webpage = "<h1>MULTIPLAYER PING PONG</h1><body bgcolor=f0f0f0>";
      sendwebdata(webpage);
      webpage="SCORE";
      sendwebdata(webpage);
      webpage=P1points;
